...
{{/*
Keycloak Operator controller role name.
*/}}
{{- define "keycloak-operator.controllerName" -}}
{{ printf "%s-%s" (include "keycloak-operator.fullname" .) "controller" }}
{{- end }}

{{/*
Keycloak Operator import controller role name.
*/}}
